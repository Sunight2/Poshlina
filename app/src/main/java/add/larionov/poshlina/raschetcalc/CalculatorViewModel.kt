...
class CalculatorViewModel : ViewModel() {
    ...
    private fun performCalculation() {
        ...
        val result1 = when (number1) {
            ...
            in 0.0000001..100000.00 -> 4000.00
            in 100000.01..300000.00 -> 4000.00 + ((number1 - 100000) / 100 * 3)
            in 300000.01..500000.00 -> 10000.00 + ((number1 - 300000) / 100 * 2.5)
            in 500000.01..1000000.00 -> 15000.00 + ((number1 - 500000) / 100 * 2)
            in 1000000.01..3000000.00 -> 25000.00 + ((number1 - 1000000) / 100 * 1)
            in 3000000.01..8000000.00 -> 45000.00 + ((number1 - 3000000) / 100 * 0.7)
            in 8000000.01..24000000.00 -> 80000.00 + ((number1 - 8000000) / 100 * 0.35)
            in 24000000.01..50000000.00 -> 136000.00 + ((number1 - 24000000) / 100 * 0.3)
            in 50000000.01..100000000.00 -> 214000.00 + ((number1 - 50000000) / 100 * 0.2)
            in 100000000.01..10000000000.00 -> 314000.00 + ((number1 - 100000000) / 100 * 0.15)
            else -> 0
        }
    ...
    private fun performCalculation2() {
        ...
        val result1 = when (number1) {
            ...
            in 3000000.01..8000000.00 -> (45000.00 + ((number1 - 3000000) / 100 * 0.7)) / 100 * 30
            in 8000000.01..24000000.00 -> (80000.00 + ((number1 - 8000000) / 100 * 0.35)) / 100 * 30
